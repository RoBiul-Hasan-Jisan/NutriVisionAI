...
export default function LoginPage() {
  ...
  const handleEmailLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // AuthContext will handle profile check; redirect after
    ...
    <div className="min-h-screen bg-grid radial-bg flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2" style={{ fontFamily: 'Syne' }}>Welcome back</h1>
          <p style={{ color: 'rgba(232, 230, 240, 0.5)' }}>Sign in to access your messages</p>
        </div>
        ...
        <div className="glass p-8 rounded-2xl">
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div>
              <label className="block text-sm mb-2" style={{ color: 'rgba(232, 230, 240, 0.7)', fontFamily: 'Inter' }}>
                Email
              </label>
