...
export const HeroSection: React.FC<HeroSectionProps> = ({ onCreateClick }) => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-[#060709]">
      ...
      ════════════════════════════ */}
      <div className="relative z-10 mx-auto flex min-h-screen max-w-4xl flex-col items-center justify-center px-6 py-8 text-center">
        ...
        {/* Status pill - Reduced margin */}
        <motion.div
          initial={{ opacity: 0, y: 8 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6, delay: 0.05 }}
          className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/9 bg-white/4 px-4 py-1.5"
        >
        ...
        <motion.h1
          ...
          className="mb-3 max-w-3xl text-[2rem] font-bold leading-[1.08] tracking-[-0.04em] text-white md:text-[3.2rem]"
        ...
        <motion.p
          ...
          className="mb-5 max-w-110 text-[0.9rem] leading-[1.6] text-white/36"
        ...
        >
          <button
            ...
            className="h-10 rounded-xl px-6 text-[0.8rem] font-semibold tracking-wide text-[#060709] transition-all duration-200 hover:scale-[1.015]"
            style={{
          ...
          <Link href="/login">
            <button
              className="h-10 rounded-xl border border-white/10 bg-transparent px-6 text-[0.8rem] font-medium tracking-wide text-white/50 transition-all duration-200 hover:border-white/[0.18] hover:bg-white/[0.04] hover:text-white/70"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              Sign In
            </button>
        ...
        <motion.div
          ...
          className="my-6 h-px w-full max-w-2xl bg-gradient-to-r from-transparent via-white/[0.07] to-transparent"
        />
        ...
        >
          {FEATURES.map((f, i) => (
            ...
            >
              <p
                className="mb-1.5 text-[9px] font-medium tracking-[0.18em] uppercase text-white/18"
                style={{ fontFamily: "'DM Mono', monospace" }}
              >
                {f.index}
              </p>
              <h3
                className="mb-1 text-[0.8rem] font-semibold leading-tight text-white/75"
